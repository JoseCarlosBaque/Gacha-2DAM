 ...
 * @author joseb
 */
@WebServlet(name = "TiradasServlet", urlPatterns = {"/tiradaSingle"})
public class TiradasSingleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ClassNotFoundException, CloneNotSupportedException {
        ...
        if (ds.get(0).getCantidad() >= 5) {
            ds.get(0).setCantidad(ds.get(0).getCantidad() - 5);
            ...
            if (encontrado == true) {
                ...
                pjs.get(i).setEstrellas(pjs.get(i).getSoul() / 1000);
            } else {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(TiradasSingleServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
